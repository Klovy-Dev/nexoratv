...
/**
 * Liens de sideload (Fire TV Stick / Android TV / box) :
 * - `nexoratv.fr/apk` : toujours le dernier APK (302, code Downloader dessus) ;
 * - `nexoratv.fr/X.Y.Z.apk` : une version précise (redirect dans next.config).
 */
